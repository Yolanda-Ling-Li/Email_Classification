...
>>>>>>> b228f054c9844859970af00e676fcb320b1f6142
    window_size = 8  # 窗口大小
    ...
    data_dir = os.path.join(os.path.abspath(os.path.dirname(os.path.dirname(__file__))), "data/under_sample_data.csv")
...
def word2vec_model(data, config):
    ...
    index_dict, word_vectors, x_index = create_dictionaries(vocab_dim=config.vocabulary_dim, max_len=config.max_len,
